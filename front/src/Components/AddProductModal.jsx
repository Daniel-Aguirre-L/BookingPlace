...
const AddProductModal = ({ onClose, isOpen, currentData, isEditing }) => {
  ...
  return (
    <div className="animate-fadeIn hs-overlay fixed top-0 left-0 w-full h-full d-flex my-0 mx-auto bg-black bg-opacity-50 py-8 z-50 backdrop-blur">
      <div className=" my-0 mx-auto flex flex-col md:w-760 bg-[#EEE] border shadow-sm rounded-xl pointer-events-auto h-[85vh] overflow-auto">
        ...
        <form onSubmit={handleSubmit}>
          <div className="flex gap-12 overflow-y-visible justify-center">
            {/** form */}
            <div className='py-4 flex gap-3 flex-col w-80'>
              <div>
            ...
            <div className='py-4 flex gap-10 flex-col'>
              <div>
