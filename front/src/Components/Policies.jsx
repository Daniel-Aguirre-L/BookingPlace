    ...
    return (
        <div>
            ...
            <div className="flex justify-between items-center p-4">
                ...
                >
                    {expanded ? "Ver todo" : "Ver todo"}
                </button>
            </div>

            <h3 className="text-lg font-montserrat p-4 -mt-2">
            ...
            <ul className="list-disc pl-5 space-y-2">
                ...
                <ul className="list-inside list-disc pl-4">
                    <li className="font-montserrat font-normal text-sm">
                ...
                {expanded && (
                    <>
                        ...
                        <p>¡Disfruta tu estancia y si necesitas algo, no dudes en contactarnos!</p>
                    </>
                )}
            </ul>
        </div>
