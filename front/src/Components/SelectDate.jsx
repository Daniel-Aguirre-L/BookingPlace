            ...
            <div className="pt-14 md:pt-16 w-full">
              <form onSubmit={handleSubmit} className="space-y-6 w-full">
                <div className=" flex flex-col gap-6 justify-center items-center">
                  ...
                  {
                    bookingDates[0] &&
                    <span className="flex justify-between items-center text-primary-color text-xs md:text-sm px-2">
                    <label htmlFor="bookingDates">Fecha de ingreso</label>
                    <label htmlFor="bookingDates">Fecha de salida</label>
                  </span>
                  }
                  <span className="flex gap-3 md:gap-10 text-sm md:text-base px-2">
                    <InputField
                      id="bookingDates"
                      name="bookingDates"
